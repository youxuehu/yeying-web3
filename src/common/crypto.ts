...
export async function digest(data: string | BufferSource, algorithm: AlgorithmIdentifier = "SHA-256"): Promise<Uint8Array> {
...
export async function generateKey(algorithm: AlgorithmIdentifier = "AES-GCM", length: number = 256): Promise<CryptoKey> {
    const param = {
        name: typeof algorithm === "string" ? algorithm : algorithm.name,
        length
    } as AesKeyGenParams
...
export async function encrypt(key: CryptoKey, data: string | BufferSource, iv: Uint8Array, algorithm: AlgorithmIdentifier = "AES-GCM"): Promise<ArrayBuffer> {
...
export async function decrypt(key: CryptoKey, data: BufferSource, iv: Uint8Array, algorithm: AlgorithmIdentifier = "AES-GCM"): Promise<ArrayBuffer> {
    const param = {
        name: typeof algorithm === "string" ? algorithm : algorithm.name,
        iv
    } as AesGcmParams
